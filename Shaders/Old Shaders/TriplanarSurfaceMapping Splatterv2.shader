...
Shader "Triplanar/Surface Shader (RNM) splatter2" {
    Properties {
    ...
    SubShader {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o) {
            ...
            float2 uvX = _SurfPts.zy * _MainTex_ST.xy + _MainTex_ST.zy;
            float2 uvY = _SurfPts.xz * _MainTex_ST.xy + _MainTex_ST.zy;
            float2 uvZ = _SurfPts.xy * _MainTex_ST.xy + _MainTex_ST.zy;
