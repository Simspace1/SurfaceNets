...
public class TerrainGen2
{
    ...
    public ColumnGen GenerateColumnGen(WorldPos pos){
        float[,] terrainHeight = new float[Chunk.chunkVoxels+4,Chunk.chunkVoxels+4];
        float[,] stoneHeight = new float[Chunk.chunkVoxels+4,Chunk.chunkVoxels+4];
        ...
        float min = 0;
        float max = 0;
        for (float x = pos.x-Chunk.voxelSize ; x<pos.x+Chunk.chunkSize+Chunk.voxelSize*3; x += Chunk.voxelSize){
            for (float z = pos.z-Chunk.voxelSize ; z<pos.z+Chunk.chunkSize+Chunk.voxelSize*3; z += Chunk.voxelSize){
